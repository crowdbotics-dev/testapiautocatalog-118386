...
## Project Structure
    ...
    ├── testapiautocatalog_118386  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_118386`
...
2. Clone this repo and `cd testapiautocatalog_118386`
